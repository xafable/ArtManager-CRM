    ...
    <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="input-group mb-3 ">
            ...
            <?php elseif($attribute->format == 'date'): ?>
                <input disabled data-attribute name="value[<?php echo e($attribute->id); ?>]" type="date" value="<?php echo e($attribute->getValue()); ?>" class="form-control"  aria-describedby="basic-addon1">
...
<?php echo $__env->make('main.workObjectLayot', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\ArtManager\resources\views/workObjectEdit.blade.php ENDPATH**/ ?>